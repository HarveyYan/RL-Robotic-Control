...
class Experiment:
    ...
    def __init__(self, env_name, discount, num_iterations, lamb, animate, kl_target, show):
        ...
        self.policy = QPropPolicy(self.obs_dim, self.act_dim, self.env.action_space, kl_target, epochs=5)
    ...
    def run_expr(self):
        ...
        while i < self.num_iterations:
            ...
            """train critic"""
            self.critic.fit(self.policy, self.buffer, epochs=1, num_samples=E*T) # take E*T samples, so in total E*T gradient steps
